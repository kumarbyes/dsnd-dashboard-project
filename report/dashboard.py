...
class Subheader(BaseComponent):
    ...
    def build_component(self, entity_id, model):
        ...
        # containing the model's name attribute
        return H2('Notes Table')  # noqa: F405
...
class LineChart(MatplotlibViz):
    ...
    def visualization(self, entity_id, model):
        ...
        df[['positive_events', 'negative_events']] = \
            df[['positive_events', 'negative_events']].cumsum()
        ...
        ax.set_title(f"Cumulative positive and negative events for \
                     {model.name} with ID = {entity_id}")
...
class BarChart(MatplotlibViz):
    ...
    def visualization(self, entity_id, model):
        ...
        pred_output = self.predictor.predict_proba(data)
...
class Report(CombinedComponent):
    ...
    children = [Header(), DashboardFilters(),
                Visualizations(), Subheader(), NotesTable()]
